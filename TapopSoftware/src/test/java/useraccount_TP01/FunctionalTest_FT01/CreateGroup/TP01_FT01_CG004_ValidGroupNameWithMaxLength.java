...
public class TP01_FT01_CG004_ValidGroupNameWithMaxLength {
    ...
    public static void createGroup(WebDriver driver) throws Exception {
        ...
        addGroupName.sendKeys("Max Length group name 34567890");
    ...
    try {
    	wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='group-grid']/table/tbody//td[contains(text(),'Max Length group name 34567890')]")));
    ...
    public static void deleteGroup(WebDriver driver) throws Exception {
        ...
        WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[td[text()='Max Length group name 34567890']]/td/a[@class='btnDeleteGroup']")));
        deleteButton.click();
