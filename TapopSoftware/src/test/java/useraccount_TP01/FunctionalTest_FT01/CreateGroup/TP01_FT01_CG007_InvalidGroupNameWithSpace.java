...
public class TP01_FT01_CG007_InvalidGroupNameWithSpace {
    ...
    public static void createGroup(WebDriver driver) throws Exception {
     ...
     public static void deleteGroup(WebDriver driver) throws Exception {
         ...
         WebElement deleteButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//tr[td[text()=' ']]/td/a[@class='btnDeleteGroup']")));
         deleteButton.click();
         ...
         try {
         	wait.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[@id='group-grid']/table/tbody//td[normalize-space(text())=' ']")));
