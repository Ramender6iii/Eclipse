...
public class TP01_FT01_CG008_InvalidGroupNameWithEmptyName {
    ...
    private static final String GROUP_NAME = "";            // Group name (empty in this case)
    ...
    public static class GroupManagementTest {
        ...
        // Method to create a group with invalid group name (empty)
