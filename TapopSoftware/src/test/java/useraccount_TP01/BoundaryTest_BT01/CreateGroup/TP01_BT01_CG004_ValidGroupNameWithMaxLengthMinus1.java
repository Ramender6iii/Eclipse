...
public class TP01_BT01_CG004_ValidGroupNameWithMaxLengthMinus1 {
    ...
    private static final String GROUP_NAME = "ABCDEFG !@ hijklmn #$ 0123456";  // Group name (max-1: 29 character)
